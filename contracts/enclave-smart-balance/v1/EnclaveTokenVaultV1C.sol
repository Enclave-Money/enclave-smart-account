...
contract EnclaveTokenVaultV1C is ReentrancyGuard, IEnclaveTokenVaultV1, IDapp {

    enum WithdrawalMode {
        WITHDRAW_SPECIFIC,  // For withdrawing a specific amount
        WITHDRAW_ALL       // For withdrawing entire balance
    }
    ...
    function getWithdrawalHash(address _tokenAddress, uint256 _mode, uint256 _amount, address _sender) public view returns (bytes32 hash) {
        ...
        hash = keccak256(abi.encode(_tokenAddress, _mode, amount, _sender, block.chainid));
    }
