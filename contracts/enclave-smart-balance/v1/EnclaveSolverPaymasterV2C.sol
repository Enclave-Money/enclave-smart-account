...
contract EnclaveSolverPaymasterV2C is BasePaymaster {
    ...
    event SolverSponsored(address indexed user, address indexed tokenAddress, uint256 creditAmount, uint256 futureDebitAmount, address indexed paymaster);
    ...
    function claim(UserOperation calldata userOp, bytes32 hash, bytes calldata requestMetadata) public {
        ...
        emit SolverSponsored(userOp.getSender(), _tokenAddress, _creditAmount, _debitAmount, address(this));
    }
