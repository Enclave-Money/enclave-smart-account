...
contract SmartAccountECDSAValidator is IValidator {
        ...
        returns (uint256)
    {
        ...
        address owner = SmartAccountV1(payable(userOp.sender)).owner();
        ...
        returns (bytes4)
    {
        ...
        address owner = SmartAccountV1(payable(msg.sender)).owner();
