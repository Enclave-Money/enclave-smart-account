...
contract EnclaveSolverPaymasterV1Patch is BasePaymaster {
    ...
    uint256 private constant SIGNATURE_OFFSET = 148;       // updated
// ... existing code ...
        ...
        returns (bytes memory context, uint256 validationData)
    {
        ...
        if (verifyingSigner != ECDSA.recover(hash, signature)) {
            ...
            require(IERC20(_tokenAddress).transfer(userOp.getSender(), _amount), "Solver Sponsor failed");
        ...
        returns (uint48 validUntil, uint48 validAfter, address tokenAddress, uint256 amount, bytes calldata signature)
    {
        ...
        console.log("TOKEN_ADDRESS_OFFSET: ", validAfter, validUntil);
