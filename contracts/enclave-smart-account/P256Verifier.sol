...
contract P256Verifier {
    ...
    function ecdsa_verify(
        ...
        console.log("x (hex)", Strings.toHexString(pubKey[0]));
        console.log("y (hex)", Strings.toHexString(pubKey[1]));

        console.log("messageHash", Strings.toHexString(uint256(message_hash)));
        ...
        console.log("RX Value: ", r_x);
        console.log("Result: ", r_x % n == r);
