...
contract SmartAccount is BaseAccount, TokenCallbackHandler, UUPSUpgradeable, Initializable {
     ...
     */
    function initialize(address anOwner, address _entryPoint) public virtual initializer {
        _initialize(anOwner, _entryPoint);
    }

    function _initialize(address anOwner, address _entrypoint) internal virtual {
        owner = anOwner;
