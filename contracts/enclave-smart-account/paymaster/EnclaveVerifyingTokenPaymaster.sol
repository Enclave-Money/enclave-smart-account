...
contract EnclaveVerifyingTokenPaymaster is BasePaymaster {
    ...
    constructor(IEntryPoint _entryPoint, address _verifyingSigner, address _paymentToken, address _feeLogicContract) BasePaymaster(_entryPoint) {
