...
async function main() {
  ...
  console.log(`VERIFIER_ADDRESS=${await verifyingSigner.getAddress()}`);
    ...
    const depoistTx = await enclaveVerifyingPayamster.deposit({value:ethers.parseEther("0.01")});
    ...
    await enclaveRegistry.updateRegistryAddress("paymentToken", "0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85");
