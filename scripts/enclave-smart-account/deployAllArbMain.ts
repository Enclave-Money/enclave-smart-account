...
async function main() {
  ...
  console.log(`VERIFIER_ADDRESS=${await verifyingSigner.getAddress()}`);
    ...
    const depoistTx = await enclaveVerifyingPayamster.deposit({value:ethers.parseEther("0.012")});
    ...
    await enclaveRegistry.updateRegistryAddress("paymentToken", "0xaf88d065e77c8cC2239327C5EDb3A432268e5831");
