...
async function main() {
    ...
    console.log("P256Verifier deployed to: ", p256verifier.target);
    // const p256verifier = p256VerifierFactory.attach("0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9");

    //@ts-ignore
    const res = await p256verifier.ecdsa_verify(hash2Digest, signature.r, signature.s, publicKeyArr);
    console.log("Res: ", res);
}
